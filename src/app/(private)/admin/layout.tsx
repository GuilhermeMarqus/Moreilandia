...
import { Menu, Search, PenLine, Trash2, LogOut } from "lucide-react";
...
export default function AdminLayout({
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        console.error("Erro ao analisar informações do usuário do localStorage:", error);
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("token"); // Remover também o token
    router.push("/login");
  };
