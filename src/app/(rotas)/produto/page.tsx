...
const ProductPage = () => {
  const productData = {
    ...
    condition: "novo",
    description:
      "Cilindro alvelolador de cera de abelhas manual doméstico em resina de poliéster (a mesma usada na fabricação de lanchas) com alta resistência. Tamanho: 28,5 cm de comprimento e 3,9 cm de diâmetro de cada rolo. Produz alvéolos de 5,25mm, próprias para abelhas africanizadas, que é uma média entre as africanas(4,8mm) e as europeias(5,5mm).",
    characteristics: [
    ...
    observations:
      "Observações: Os produtos da APIC estão presentes a mais de 30 anos no mercado e são testadas antes do envio, por isso, possuem garantia de 1 ano contra defeitos de fabricação e desgaste do cilindro.",
    includes:
      "O produto vem com um livreto sobre a cera de abelha que possui instruções de uso.",
    images: [
    ...
    memberSince: "2025",
    apicultorId: "1", // Exemplo de ID do apicultor
  };
